...
#use ggplot to assign plot1 and plot2, the code below to combine them
...
# for value pulled from columns with one value, be sure to use [1]
...
grid.arrange(newplot, plot2, nrow = 2) 
...
is.na(yourdatacolumn[yourdatacolumn == 0]) <- TRUE
